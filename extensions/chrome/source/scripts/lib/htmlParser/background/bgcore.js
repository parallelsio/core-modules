...
define(['lib/htmlParser/background/nio', 'lib/htmlParser/common/util', 'lib/htmlParser/common/processor', 'lib/htmlParser/background/wininfo', 'browser'],
  function (nio, util, processor, wininfo, browser) {
    var core = {};
